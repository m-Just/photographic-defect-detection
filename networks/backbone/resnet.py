...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv1 = conv3x3(inplanes, planes, stride=stride, bias=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = conv3x3(width, width, stride=stride, bias=False, groups=groups,
...
def resnet(num_layers, **kwargs):
    if num_layers == 18:
        ...
        net = ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)
    elif num_layers == 50:
        net = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    elif num_layers == 101:
        net = ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)
    elif num_layers == 152:
        net = ResNet(Bottleneck, [3, 8, 36, 3], **kwargs)
    else:
        raise ValueError()
    return net
